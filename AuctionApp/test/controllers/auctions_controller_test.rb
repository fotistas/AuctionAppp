...
class AuctionsControllerTest < ActionController::TestCase
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post :create, auction: { auction_id: @auction.auction_id, auction_item: @auction.auction_item, item_owner: @auction.item_owner }
    end
  ...
  test "should update auction" do
    patch :update, id: @auction, auction: { auction_id: @auction.auction_id, auction_item: @auction.auction_item, item_owner: @auction.item_owner }
    assert_redirected_to auction_path(assigns(:auction))
  end
